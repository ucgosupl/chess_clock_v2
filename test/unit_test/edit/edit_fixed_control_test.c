...
TEST_GROUP(edit_fixed_control);

TEST_SETUP(edit_fixed_control)
{
...
TEST_TEAR_DOWN(edit_fixed_control)
{
    /* Cleanup after every test */
}

TEST(edit_fixed_control, P1AddHours)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1SubtractHours)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1SubtractHourBounds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddHourBounds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1LeftBounds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddTenMinutes)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddMinutes)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddTenSeconds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddSeconds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddHours)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddTenMinutes)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddMinutes)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddTenSeconds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddSeconds)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddTenMoves)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P1AddMoves)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddTenMoves)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, P2AddMoves)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, EditNotDone)
{
    const struct config_controller * edit = mode_edit_controller_get();
...
TEST(edit_fixed_control, EditDone)
{
    const struct config_controller * edit = mode_edit_controller_get();
