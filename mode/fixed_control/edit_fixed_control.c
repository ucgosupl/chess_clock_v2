...
static void edit_fixed_control_on_entry(config_completed_cb_t cb)
{
    const struct game_controller *game = fixed_control_game_controller_get();
...
static void edit_fixed_control_on_exit(void)
{
	const struct edit_builder *builder = fixed_control_edit_builder_get();
...
static void edit_fixed_control_on_right(void)
{
	state++;
...
static void edit_fixed_control_display(void)
{
...
static const struct config_controller edit_controller_fixed_control =
{
		edit_fixed_control_on_entry,
		edit_fixed_control_on_exit,
		edit_fixed_control_on_plus,
		edit_fixed_control_on_minus,
		edit_fixed_control_on_left,
		edit_fixed_control_on_right,
		edit_fixed_control_display,
};

const struct config_controller * fixed_control_edit_controller_get(void)
{
	return &edit_controller_fixed_control;
}
