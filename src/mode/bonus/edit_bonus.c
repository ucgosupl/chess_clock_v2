...
static void edit_bonus_on_entry(config_completed_cb_t cb)
{
    const struct game_controller *game = bonus_game_controller_get();
...
static void edit_bonus_on_exit(void)
{
...
static void edit_bonus_on_left(void)
{
	if (0 < state)
	{
		state--;
...
static void edit_bonus_on_right(void)
{
	state++;
