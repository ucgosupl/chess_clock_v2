...
static void fixed_control_on_entry(config_completed_cb_t cb)
{
...
static void fixed_control_on_exit(void)
{
	const struct mode_builder *builder = fixed_control_mode_builder_get();
...
static void fixed_control_on_right(void)
{
	state++;
...
static void fixed_control_display(void)
{
	if (state < P1_INC_MIN)
	{
...
static const struct config_controller config_fixed_control =
{
		fixed_control_on_entry,
		fixed_control_on_exit,
		fixed_control_on_plus,
		fixed_control_on_minus,
		fixed_control_on_left,
		fixed_control_on_right,
		fixed_control_display,
};

const struct config_controller * fixed_control_config_controller_get(void)
{
	return &config_fixed_control;
}
